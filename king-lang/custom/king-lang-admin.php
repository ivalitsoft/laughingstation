...
*/	
	...
	return array(
		...
		'categories_not_shown' => 'Some Media have categories which will not be displayed.',
		...
		'category_no_sub_error' => '^q Media/s in this category have no sub-category - ^1set sub-category^2',
		'category_no_sub_to' => 'Move Media in ^ with no sub-category to:',
		'category_no_subs' => 'None',
		'category_none_error' => '^q Media/s currently have no category - ^1set category^2',
		'category_none_to' => 'Move Media with no category to:',
		...
		'delete_category_reassign' => 'Delete this category and reassign its Media to:',
		...
		'delete_hidden_note' => ' - all hidden Media, Comment and comments without dependents',
		...
		'hidden_Media_deleted' => 'Deleted ^1 of ^2 hidden Media without dependents...',
		'hotness_factors' => 'Relative importance for Media hotness:',
		'hidden_title' => 'Hidden',
		'ip_address_pages' => 'IP address pages',
		'layout_title' => 'Layout',
		'link_name' => 'Text of link:',
		'link_new_window' => 'Open link in a new window',
		'link_url' => 'URL of link - absolute or relative to Media root:',
		'lists_title' => 'Lists',
		...
		'question_lists' => 'Media lists',
		'question_pages' => 'Media pages',
		...
		'recalc_categories_recounting' => 'Recounting Media for ^1 of ^2 categories...',
		...
		'recalc_posts_count' => 'Getting total number of Media, Comments and comments...',
		...
		'refill_events_refilled' => 'Refilled for ^1 of ^2 Media...',
		'refill_events' => 'Refill event streams',
		'reindex_content' => 'Reindex content',
		'reindex_content_note' => ' - for searching and related Media suggestions',
		...
		'tags_not_shown' => 'Some Media have tags which will not be displayed.',
		'tags' => 'Tags',
		...
		'version_requires_q2a' => '^1 requires Media ^2', 

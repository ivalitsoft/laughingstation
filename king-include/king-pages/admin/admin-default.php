	...
	switch ($adminsection) {
		...
		case 'users':
			...
			if (!QA_FINAL_EXTERNAL_USERS) {
				...
				array_push($showoptions, 'show_custom_register', 'custom_register', 'show_register_terms', 'register_terms', 'show_notice_welcome', 'notice_welcome', 'show_custom_welcome', 'custom_welcome', 'allow_login_email_only');
			
				array_push($showoptions, 'allow_user_walls', 'allow_private_messages', 'show_message_history', 'page_size_pms', 'page_size_wall', '', 'avatar_allow_gravatar');
		...
		case 'layout':
			...
			$showoptions=array('logo_show', 'logo_url', 'show_custom_sidebar', 'custom_sidebar', 'show_custom_header', 'custom_header', 'show_custom_footer', 'custom_footer', 'show_custom_in_head', 'custom_in_head', 'show_home_description', 'home_description', 'show_ad_post_below', 'ad_post_below', '');
		...
		case 'viewing':
			...
			array_push($showoptions, '', 'disable_image', 'disable_video', 'disable_news', '','image_max_upload', 'image_max_file_count', 'video_max_upload', 'video_ffmpeg', 'fb_user_token', 'disable_watermark', '', 'footer_fb', 'footer_twi', 'footer_google', 'footer_ytube', 'footer_pin', '', 'sort_answers_by', 'page_size_q_as');
		...
		case 'lists':
			...
			$showoptions=array('do_close_on_select', 'links_in_new_window', '', 'show_custom_ask', 'custom_ask', 'show_custom_answer', 'custom_answer', '', 'allow_close_questions', 'follow_on_as', '', 'page_size_qs');

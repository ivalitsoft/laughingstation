...
/*
	...
	File: king-include/king-page-question-post.php
...
*/
	...
	require_once QA_INCLUDE_DIR.'king-pages/question-submit.php';
...
//	Functions used above - also see functions in king-page-question-submit.php (which are shared with Ajax)
...
*/
	{
		$edit = isset($in['extra']) ? $in['extra'] : $question['extra'] ;
		$form=array(
			...
			'fields' => array(
				'thumb' => array(
					'type' => 'custom',
					'html' => '<div class="king-editthumb"><img id="king-editthumb" src="'.qa_html(isset($in['content']) ? $in['content'] : $question['content']).'" /></div>',
				),
				'title' => array(
				...
				'imgprev' => array(
					'label' => 'Thumbnail',
					'type' => 'custom',
					'html' => '<div id="multipleupload">Upload</div>',
				),				
				'content' => array(

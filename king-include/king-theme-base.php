...
//	search() outputs <div class="king-search">, q_list() outputs <div class="king-q-list">, etc...
	...
	public function notice($notice)
	{
		...
		$this->output('<input '.$notice['close_tags'].' type="submit" value="X" class="king-notice-close-button"/> ');
	...
	{
		$this->output('<input type="text" '.$search['field_tags'].' value="'.@$search['value'].'" class="king-search-field"/>');
	}

	public function search_button($search)
	{
		$this->output('<input type="submit" value="'.$search['button_label'].'" class="king-search-button"/>');
	}
	...
	public function attribution()
	{
		...
		$this->output(
			...
			'Powered by <a href="http://www.King-Media.org/">King-Media</a>',
			'</div>'
		);
	}

...
if(isset($_POST))
{
	...
	$pageurl = (isset($_SERVER['HTTPS']) ? "https://" : "http://") . ''.@$_SERVER['HTTP_HOST'].strtr(dirname($_SERVER['SCRIPT_NAME']), '\\', '/').'';
...
<img src="$pageurl/$path" alt="Resized Image">
<label onclick="document.getElementById('imgprev').src = '$pageurl/$path';document.getElementById('content').value = '$pageurl/$path2';document.getElementById('extra').value = '$pageurl/$path';" class="img-submit" for="checkbox-menu3">OK</label>
</div>
XYZ;
echo $variable;
		/*

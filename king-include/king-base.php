...
*/
	...
	define('QA_VERSION', '4.1'); // also used as suffix for .js and .css requests
...
*/
	{
		...
		if (!defined('QA_BASE_DIR'))
			define('QA_BASE_DIR', dirname(dirname(__FILE__)).'/'); // try out best if not set in index.php or king-index.php - won't work with symbolic links
...
*/
	{
		...
		qa_register_module('widget', 'king-addons/king-widget-related-qs.php', 'qa_related_qs', 'Related Media');
	}
